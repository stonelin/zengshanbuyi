...
- **已完成 86 条**（`src/data/cases_v2.json` 里有 86 条记录，`case_015`
  的历史缺口已在本轮补上）。
- 已完成的 ID：`case_002` 到 `case_080`（不含 `case_001`），加上从边界
  识别问题里顺手捞回来的"bonus"案例：`case_019b` `case_020b` `case_020c`
  `case_036b` `case_040b` `case_047` `case_048` `case_049` `case_050`
  `case_064b` `case_077b`。
...
1. 从 `case_081` 继续往后做，一直到 `case_323`（`src/data/cases.json`
